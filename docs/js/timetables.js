...
const TimetableModule = (function() {
    ...
    function init() {
        ...
        `;
        overlay.innerHTML = `
            <div style="position: relative; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; overflow: hidden; animation: ttShellFade 0.45s ease-out;">
                <span style="position:absolute; width: 280px; height: 280px; border-radius: 50%; background: rgba(96, 165, 250, 0.18); filter: blur(28px); top: 12%; left: 18%; animation: ttOrbFloat 7s ease-in-out infinite;"></span>
                <span style="position:absolute; width: 220px; height: 220px; border-radius: 50%; background: rgba(125, 211, 252, 0.18); filter: blur(24px); bottom: 10%; right: 18%; animation: ttOrbFloat 9s ease-in-out infinite reverse;"></span>
                <span style="position:absolute; width: 170px; height: 170px; border-radius: 50%; background: rgba(191, 219, 254, 0.24); filter: blur(22px); top: 38%; right: 28%; animation: ttOrbFloat 8s ease-in-out infinite;"></span>

                <div style="position: relative; width: min(430px, 92vw); padding: 28px 28px 24px; border-radius: 28px; background: rgba(255, 255, 255, 0.72); border: 1px solid rgba(148, 163, 184, 0.28); box-shadow: 0 22px 60px rgba(37, 99, 235, 0.14), inset 0 1px 0 rgba(255,255,255,0.7); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); animation: ttCardRise 0.6s cubic-bezier(.2,.8,.2,1);">
                    <div style="position:absolute; inset: 0 auto auto 0; width: 100%; height: 4px; border-radius: 28px 28px 0 0; background: linear-gradient(90deg, #2563eb, #38bdf8, #60a5fa, #2563eb); background-size: 200% 100%; animation: ttLoadBarSweep 2.6s ease-in-out infinite;"></div>
                    ...
                    <div style="text-align:center;">
                        <h2 style="margin: 0 0 10px; color: #0f172a; font-size: clamp(1.4rem, 2vw, 1.8rem); font-weight: 900; letter-spacing: -0.04em; text-transform: uppercase; font-family: 'Segoe UI', 'Trebuchet MS', 'Arial Black', sans-serif; text-shadow: 0 1px 0 rgba(255,255,255,0.4); animation: ttTextFade 0.9s ease-out;">Timetable Module</h2>
                        <p style="margin: 0; color: #475569; font-size: 0.98rem; font-weight: 500; line-height: 1.6; font-family: 'Segoe UI', 'Trebuchet MS', sans-serif; letter-spacing: 0.01em; animation: ttTextFade 1.1s ease-out;">Loading school data and preparing scheduling tools...</p>
                    </div>
                </div>
            </div>
            <style>
              @keyframes ttLoadBarSweep {
              ...
              @keyframes ttCardRise {
                0% { opacity: 0; transform: translateY(18px) scale(0.98); }
                100% { opacity: 1; transform: translateY(0) scale(1); }
              }
              @keyframes ttTextFade {
                0% { opacity: 0; transform: translateY(6px); }
                100% { opacity: 1; transform: translateY(0); }
              }
              @keyframes ttShellFade {
                0% { opacity: 0; }
                100% { opacity: 1; }
              }
            </style>
